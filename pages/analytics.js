...
export default function Analytics() {
    ...
    useEffect(() => {
        ...
        const unsubscribeBills = onSnapshot(collection(db, 'bills'), (snapshot) => {
            ...
            console.log("Bills loaded for Analytics:", billsData.length);
        }, (error) => {
        ...
        const unsubscribeProducts = onSnapshot(collection(db, 'products'), (snapshot) => {
            ...
            console.log("Products loaded for Analytics:", productsData.length);
        }, (error) => {
        ...
        const unsubscribeCustomers = onSnapshot(collection(db, 'customers'), (snapshot) => {
            ...
            console.log("Customers loaded for Analytics:", customersData.length);
        }, (error) => {
        ...
        <div className="flex min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200">
            ...
            <aside className="w-64 bg-white dark:bg-slate-800 p-6 shadow-lg fixed h-full border-r border-slate-200 dark:border-slate-700 z-30">
                ...
                <nav className="space-y-4">
                    ...
                    <a href="/transaction-history" className="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
                        <FileText size={20} /> Lịch sử giao dịch
                    </a >
                    <a href="/analytics" className="flex items-center gap-3 p-3 rounded-lg bg-indigo-500 text-white font-semibold">
